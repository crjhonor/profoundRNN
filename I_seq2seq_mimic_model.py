...
class mimic_model:
    def __init__(self, indexWanted, sents_en, sents_fr_in, sents_fr_out, X_predict, X_predict_time,
                 nb_classes, classesTable):
        self.indexWanted = indexWanted
        self.sents_en = sents_en
        self.sents_fr_in = sents_fr_in
        self.sents_fr_out = sents_fr_out
        self.X_predict = X_predict
        self.X_predict_time = X_predict_time
    ...
    def model_train(self, num_epochs):
        ...
        data_dir = "./dl_data"
        checkpoint_dir = os.path.join(data_dir, "checkpoints/checkpointsI")
        ...
        vocab_size_en = self.nb_classes + 4
        vocab_size_fr = self.nb_classes + 4
        idx2word_en = self.classesTable['stand for'].to_dict()
        ...
        checkpoint_prefix = os.path.join(checkpoint_dir, "stdtp")
        ...
        for e in range(num_epochs):
            ...
            if e % 10 == 0:
                ...
                predict(encoder, decoder, batch_size, self.sents_en, self.sents_fr_out, word2idx_fr, idx2word_fr)
        ...
        output = predictXone(encoder, decoder,
                             self.X_predict, self.X_predict_time, batch_size, self.sents_en, self.sents_fr_out,
                             word2idx_fr, idx2word_fr)
